// Installed by the 2D Assets Pipeline tool. Reads Assets/Atlases/atlases.json (the
...
{
    private const string ManifestPath = "Assets/Atlases/atlases.json";
    ...
    private static bool BuildOne(AtlasNode node)
    {
        ...
        string atlasPath = $"Assets/Atlases/{node.name}.spriteatlas";
